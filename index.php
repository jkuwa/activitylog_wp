    ...
    <div class="p-contents js-container">
      ...
      <section id="log" class="c-content p-log js-tabContent is-open" role="tabpanel" aria-labelledby="tab_log" tabindex="0" data-tab="log">
        <div class="c-inner">
          ...
          <!-- ARCHIVE -->
          <ul class="p-log__archive">
            <li>
              <article class="p-logCard">
                <h3><time datetime="2025-03-18">2025.03.18</time></h3>
                <ul>
                  <li class="p-logCard__cat">
                    <h4>GAS</h4>
                    <p>WordPressとの連携</p>
                    <p class="c-hours">7.5</p>
                  </li>
                  <li class="p-logCard__cat">
                    <h4>スクール</h4>
                    <p>定例</p>
                    <p class="c-hours">1.25</p>
                  </li>
                </ul>
                <p class="p-logCard__text">GASに挑戦！<br>なかなか思ったように実行できず大変だったけど、できた〜<br>スッッッキリ！！</p>
              </article>
            </li>
            <li>
              <article class="p-logCard">
